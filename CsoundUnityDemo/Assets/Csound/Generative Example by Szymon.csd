...
instr 1 ; notes 
  ...
  asig buzz kenv, p4, kenv*30, giSine
  		outs asig * p5 * kVolume*0.2, asig *(1 - p5)*kVolume*0.2
  		gaRvbSendL    =         gaRvbSendL + (asig * 0.2)
  		gaRvbSendR    =         gaRvbSendR + (asig * 0.2)
endin
...
instr 4 ;bass
	...
	gaRvbSendL = gaRvbSendL + asig
   gaRvbSendR = gaRvbSendR + asig
	outs asig, asig
endin
